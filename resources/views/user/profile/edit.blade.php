    ...
    <form action="{{route('profile.update',auth()->id())}}" class="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <div class="input-container">
                    ...
                    {{Form::date('age',$user->profile()->age,array('class'=>'input','id','age','placeholder'=>'Tu edad','required'))}}
        ...
        <div class="form-row column m-y">
            ...
            <div class="current-picture">
                <img src="{{route('image',$user->getProfilePicture())}}" alt="profile" id="current-img-picture" required>
            </div>
        </div>
